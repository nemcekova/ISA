...
# Popis programu
Aplikácia umožňuje klientovi vytvárať a spravovať nástenky na serveri. Na nástenkach je možné pridávať, mazať alebo upravovať príspevky.
Komunikácia je vytvorená pomocou BSD schránok a HTTP protokolu.
